...
Original file is located at
    https://colab.research.google.com/drive/1rHAislAFctQ5UMkkwC4WPqjkw5hclVQi
"""
...
def extract_annotations(annotated_folder, class_label='pni', visualize=True):
    img_folder = '/content/drive/MyDrive/Shreya_Annotated_Involved_test'
    output_folder = '/content/ann_grayscale1'
    ...
    df.to_csv('pni_detection_annotations.csv', index=False)
...
def train():
    output_folder = '/content/drive/MyDrive/INVOLVED_NERVE_test'
...
extract_annotations('/content/drive/MyDrive/Shreya_Annotated_Involved_test')
train()

predict_and_visualize('pni_detector.pth', '/content/drive/MyDrive/INVOLVED NERVE')
...
evaluate_model('pni_detector.pth', '/content/drive/MyDrive/INVOLVED NERVE', 'pni_detection_annotations.csv')
